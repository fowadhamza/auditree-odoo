...
class crm_lead(models.Model):
    ...
    def service_count(self):
        task_obj = self.env['project.project']
        self.project_number = task_obj.search_count([('lead_id', 'in', [a.id for a in self])])

    project_number = fields.Integer(compute='service_count', string='Tasks')
...
class project_Task(models.Model):
    ...
    inv_count = fields.Integer(compute='inv_count', string='Invoices')
